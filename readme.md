...
If you have prop randomization on, you can just run to where the standoff is supposed to be and jump over the gate with a well time explosion from blowing yourself up with a hopper. All other randomization options should work properly in this section of the game.
